...
const int MAZE_DISTANCE = 350;
const int OBSTACLE_MEASURING_DISTANCE = 150;
const int GRID_TO_COLOR_BOX_DISTANCE = 150;
const int INITIAL_REVERSING_DISTANCE = 70;

const int REVERSE_DISTANCE = 50;

const int HEIGHT_DETECTING_DISTANCE = 60;
const int PICKING_UP_DISTANCE = 20;
