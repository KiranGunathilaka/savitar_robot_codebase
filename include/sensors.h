...
public:
    ...
    int whiteThreshold[5][2] = {{503, 504}, {560, 560}, {534, 534}, {562, 562}, {588, 587}};
    float redToGreenOffset[5][2] = {{0.479556, 0.470937}, {0.454198, 0.446906}, {0.454295, 0.450967}, {0.474874, 0.475729}, {0.426300, 0.427653}};
    float redToBlueOffset[5][2] = {{0.511595, 0.500653}, {0.487278, 0.477525}, {0.487607, 0.484447}, {0.501916,0.503447 }, {0.469047, 0.470770}};
    float blueToRedOffset[5][2] = {{0.171368, 0.173695}, {0.192468, 0.194067}, {0.195743, 0.194915}, {0.171219, 0.169082}, {0.156615, 0.157550}};
    float blueToGreenOffset[5][2] = {{0.112860, 0.115165}, {0.105233, 0.107640}, {0.105119, 0.105485}, {0.107121, 0.107853}, {0.081586, 0.084111}};
    int blackThreshold[5][2] = {{36, 34}, {45, 45}, {51, 53}, {37, 42}, {46, 48}};
